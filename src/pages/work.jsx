...
function Work() {
    ...
    return (
        <div className="w-full bg-black text-white py-10 px-4 sm:px-0">
            <div className="max-w-5xl mx-auto flex flex-col gap-2 items-center text-center mb-10">
                <h1 className="text-3xl sm:text-4xl font-bold">Works &amp; Projects</h1>
                <p className="text-gray-400 max-w-xl">
                    Here is a list of the projects and collaborations I have been involved in over the past few years.
                </p>
            </div>

            <div className="max-w-5xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 items-start">
                        ...
                        <div key={project.id} className="bg-white/5 border border-gray-800 rounded-xl overflow-hidden flex flex-col">
                            ...
                            <div className="flex items-center justify-between gap-2 p-4">
                                <button
                                    ...
                                    className="flex items-center gap-1.5 px-4 py-2 rounded-lg bg-white text-black text-sm font-medium hover:bg-gray-200 transition-colors"
                                >
                                    Details
                                ...
                                <div className="flex items-center gap-2">
                                    ...
                                    <a href={project.link} target="_blank" rel="noopener noreferrer" className="w-9 h-9 flex items-center justify-center rounded-lg bg-white/10 hover:bg-white/20 transition-colors" aria-label={`Open ${project.title}`}>
